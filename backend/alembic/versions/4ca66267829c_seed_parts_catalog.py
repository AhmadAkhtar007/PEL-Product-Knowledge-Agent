...
Revision ID: 4ca66267829c
Revises: 9a7e6b5c4d32
Create Date: 2026-07-06 23:00:34.754064
...
revision: str = '4ca66267829c'
down_revision: Union[str, Sequence[str], None] = '9a7e6b5c4d32'
...
def upgrade() -> None:
    ...
    parts_table = sa.table(
        ...
        sa.column('appliance_type', sa.String),
...
def downgrade() -> None:
    """Downgrade schema."""
    op.execute("DELETE FROM parts WHERE part_number LIKE 'PEL-%'")
